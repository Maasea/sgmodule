...
// @generated from protobuf file "youtube.proto" (syntax proto3)
// tslint:disable
...
export interface g3F1 {
    /**
     * @generated from protobuf field: g4F318370163 g4F318370163 = 318370163;
     */
    g4F318370163?: g4F318370163;
}
/**
 * @generated from protobuf message g4F318370163
 */
export interface g4F318370163 {
}
/**
...
class g3F1$Type extends MessageType<g3F1> {
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: g3F1): g3F1 {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* g4F318370163 g4F318370163 */ 318370163:
...
// @generated message type with reflection information, may provide speed optimized methods
class g4F318370163$Type extends MessageType<g4F318370163> {
    constructor() {
        super("g4F318370163", []);
    }
    create(value?: PartialMessage<g4F318370163>): g4F318370163 {
        const message = {};
        globalThis.Object.defineProperty(message, MESSAGE_TYPE, { enumerable: false, value: this });
        if (value !== undefined)
            reflectionMergePartial<g4F318370163>(this, message, value);
        return message;
    }
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: g4F318370163): g4F318370163 {
        return target ?? this.create();
    }
    internalBinaryWrite(message: g4F318370163, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        let u = options.writeUnknownFields;
        if (u !== false)
            (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
        return writer;
...
/**
 * @generated MessageType for protobuf message g4F318370163
 */
export const g4F318370163 = new g4F318370163$Type();
// @generated message type with reflection information, may provide speed optimized methods
