...
export declare class Request extends Message<Request> {
  /**
   * @generated from field: Context context = 1;
   */
  context?: Context;
  ...
  static readonly typeName = "Request";
...
export declare class Context extends Message<Context> {
  /**
   * @generated from field: AdSignalsInfo adSignalsInfo = 9;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "Context";
  static readonly fields: FieldList;
...
export declare class AdSignalsInfo extends Message<AdSignalsInfo> {
  /**
   * @generated from field: repeated Params params = 1;
   */
  params: Params[];
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "AdSignalsInfo";
  static readonly fields: FieldList;
