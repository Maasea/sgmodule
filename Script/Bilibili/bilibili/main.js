...
import {handleDMView, handleModeStatus, handlePlayView, handleV1View, handleReplyList} from "./src/handler.js"

const url = $request.url;
const body = $response.body;
const decompress = (typeof $utils?.ungzip === "function") ? $utils.ungzip : gunzipSync;
